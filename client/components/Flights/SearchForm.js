...
const SearchForm = () => {
  ...
  return (
    <div className='absolute top-[500px] bg-white  md:shadow-xl rounded-lg  py-6 px-10  w-[85%] lg:w-[1282px] sm:mb-20'>
      <div className='flex flex-wrap justify-start gap-x-4 mb-8 -ml-2'>
        <div className='mx-1'>
          <input
            type='radio'
            id='one'
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4  relative '>
            ...
            <div className='col-span-1  block text-sm font-medium text-slate-700'>
              ...
              <label className=' relative block'>
                ...
                <div ref={modalRef}>
                  {modal && <Modal add={handleModalData} />}
                </div>
              </label>
            </div>
          </div>
